    ...
    <>
      <div className="flex flex-col sm:p-10 rounded-md sm:bg-[#fbfbfb]">
        ...
        <div className="flex items-center justify-center w-full mb-5 sm:justify-start">
          <button
            disabled={data?.attributes?.stock === 1}
            className="flex items-center w-full h-10 px-4 bg-transparent border border-r-0 border-gray-300 sm:w-fit rounded-tl-md rounded-bl-md"
            type="button"
          ...
          <button
            disabled={data?.attributes?.stock === 1}
            className="flex items-center w-full h-10 px-4 bg-transparent border border-l-0 border-gray-300 sm:w-fit rounded-tr-md rounded-br-md"
            type="button"
            onClick={() => setQty(qty + 1)}
          >
