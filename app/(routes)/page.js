  ...
  return (
    <Container>
      ...
      <div className="flex flex-col items-center w-full py-14 sm:py-32">
        ...
        <div className="grid w-full grid-cols-1 px-4 mb-16 text-center sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-16 sm:text-left place-items-center sm:px-6 lg:px-8 mt-14 sm:mt-20">
